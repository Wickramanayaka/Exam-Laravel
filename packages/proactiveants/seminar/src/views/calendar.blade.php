<script
  ...
  <script type="text/tmpl" id="tmpl">
    ...
    <table class="calendar-table table table-condensed table-tight">
      <thead>
        <tr>
          <td colspan="7" style="text-align: center; border:0px;">
  ...
  @foreach($bookings as $booking)
    data.push({ title: "{{$booking->seminar->name}}", start: new Date({{$booking->date->year}},{{$booking->date->month - 1}},{{$booking->date->day}},8,0), end: new Date({{$booking->date->year}},{{$booking->date->month - 1}},{{$booking->date->day}},8,0), allDay: 1});
  @endforeach
