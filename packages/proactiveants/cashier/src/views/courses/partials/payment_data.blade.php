<table style="table-layout: fixed; word-wrap: break-word" class="table table-striped table-bordered table-sm">
    <thead>
      <tr>
        <th>#</th>
        <th>Reg.</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2"><b>{{number_format($payments->sum('amount'),2)}}</b></td>
        </tr>
    </tbody>
    <tfoot>
    </tfoot>
